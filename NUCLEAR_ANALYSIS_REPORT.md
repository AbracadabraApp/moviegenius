...
I analyzed the MovieGenius database to identify movies that have analysis content but haven't been converted to nuclear static files yet. Here's what I found:
...
These movies have been analyzed but their nuclear static files haven't been generated:
...
**Complete list of TMDB IDs:** 11896, 11878, 11881, 11884, 804251, 976732, 1072790, 872585, 6557, 1034474, 762968, 881209, 802839, 1175201, 6106, 6479, 5919, 7300, 11873, 13509, 24837, 1054757, 949075, 811933, 973484, 820517, 835961, 1282378, 830488, 771464, 768386, 766507, 787434, 763390, 1220995, 876794, 779207, 820912, 855823, 1035090, 856369, 88950, 1004663, 1251838

#### 2. Nuclear Candidates Without Analysis (471 movies)

These are movies in the top 1,000 nuclear candidates but don't have analysis yet.
...
- Automated script to convert the 44 movies with analysis to nuclear static files
...
### Detection Scripts
- `detect-processed-files.js`: Analyzes which nuclear static files have been processed
...
1. **Immediate Action**: Run `convert-missing-nuclear.js` to convert the 44 movies with analysis
...
The system is 99.3% complete with only 44 movies needing nuclear conversion, indicating a very mature and well-functioning nuclear static system.