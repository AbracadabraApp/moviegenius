...
This directory contains obsolete files and legacy code that have been removed from the active codebase but preserved for reference.

## Why Quarantine?

Rather than deleting potentially valuable code history, we quarantine files that:
...
**Reason:** Early static data architecture superseded by database + TMDB integration
