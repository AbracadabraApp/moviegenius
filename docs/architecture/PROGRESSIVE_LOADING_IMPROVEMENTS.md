...
**Issue**: Images were loading immediately with placeholders, creating jarring
visual experience where placeholder → real image transitions happened too
quickly.

**Solution**: Implemented thoughtful progressive loading with delays and smooth
transitions to give images time to load before displaying them.
...
The app now feels more refined and thoughtful, giving images the time they need
to load while keeping users informed about the loading process.
