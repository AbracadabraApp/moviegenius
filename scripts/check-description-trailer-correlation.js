...
async function checkCorrelation() {
  ...
  try {
    ...
    const movieIds = [
      ...
      550, 603, 155, 13, 680, 278, 238, 424, 389, 129,
      346, 637, 769, 11216, 496243, 372058, 15804, 19404,
      // Random mix from our successful range
      101, 103, 104, 105, 111, 112, 113, 114, 115, 121,
      122, 123, 124, 132, 134, 135, 141, 142, 143, 144,
      145, 152, 153, 154, 161, 162, 163, 164, 165, 172
    ];
    ...
    console.log(`📈 Correlation rate: ${((moviesWithBoth/moviesWithDescriptions)*100).toFixed(1)}%`);
    console.log(`🎪 Trailer success rate: ${((moviesWithTrailers/movieIds.length)*100).toFixed(1)}%`);
    ...
    console.log(`📊 Estimated movies with descriptions + trailers: ${estimatedWithBoth.toLocaleString()}`);
