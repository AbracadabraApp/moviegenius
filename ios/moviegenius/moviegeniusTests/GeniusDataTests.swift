...
final class GeniusDataTests: XCTestCase {
    ...
    func testGeniusDataStructure() {
        ...
        for category in store.categories {
            ...
            for tier in category.tiers {
                ...
                XCTAssert(["Essential", "Foundational", "Connoisseur", "Specialist", "Archivist"].contains(tier.name),
    ...
    func testAllTiersPresent() {
        let store = GeniusDataStore()
        let expectedTiers = ["Essential", "Foundational", "Connoisseur", "Specialist", "Archivist"]
