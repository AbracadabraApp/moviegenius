...
This directory contains deprecated movie and entity linking systems that were
replaced by the V1 production-ready systems.

## Archived on: July 5, 2025

## Reason for Archival

These scripts created confusion in the codebase with multiple similar systems.
They have been replaced by two clean V1-ready systems for movie linking.
...
- `nuclear-link-utils.js` - Legacy nuclear linking utilities (different pattern
  system)
...
These files are archived (not deleted) in case any legacy functionality needs to
be referenced. However, they should NOT be used in production as they have been
superseded by the V1 systems.

## V1 Launch Ready

The current episode and movie analysis linking systems are production-ready and
validated for the V1 launch of moviegenius.ai.
