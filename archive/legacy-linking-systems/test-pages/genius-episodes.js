...
import { processMovieLinksForReact, extractEpisodeMovies, analyzeTextForLinks } from '../../lib/simple-entity-linker';
...
export default function GeniusEpisodesTest() {
  ...
  useEffect(() => {
    const availableEpisodes = [
      { seriesId: '1', episodeId: '1', title: 'German Expressionism', subtitle: 'The template for noir morality' },
      { seriesId: '1', episodeId: '2', title: 'From Novels to Noir', subtitle: 'Hard-boiled detective fiction meets cinema' }
    ];
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.controls}>
        <div style={styles.controlGroup}>
          ...
          >
            ...
            {episodes.map((ep) => (
              <option key={`${ep.seriesId}-${ep.episodeId}`} value={`${ep.seriesId}-${ep.episodeId}`}>
      ...
      {loading && (
        <div style={styles.loading}>Loading episode content...</div>
      )}
