...
const SERIES_DIRS = {
  1: {
    ...
    2: 'series-2-neo',
    3: 'series-3-crime',
    4: 'series-4-contemporary',
    5: 'series-5-international',
    6: 'series-6-television',
  },
  2: {
    1: 'series-1-early',
    2: 'series-2-newhollywood',
    3: 'series-3-digital',
    4: 'series-4-contemporary',
    5: 'series-5-fantasy',
    6: 'series-6-horror',
...
export default function GeniusEpisodePage({ episodeData, themeId, seriesId, episodeId }) {
...
const styles = {
  ...
  fixedInputArea: {
    padding: '16px',
    background:
      'linear-gradient(to right, rgba(0,0,0,1.0) 0%, rgba(0,0,0,0.7) 100%), linear-gradient(to bottom, rgba(0,0,0,1.0) 0%, rgba(0,0,0,1.0) 50%, rgba(0,0,0,0.3) 100%)',
