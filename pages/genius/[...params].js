...
export default function GeniusPage({ pageType, data, themeId, seriesId, episodeId }) {
  ...
  switch (pageType) {
    case 'theme':
      return <ThemePage data={data} handleSearchResults={handleSearchResults} />;
    case 'series':
      return <SeriesPage data={data} themeId={themeId} handleSearchResults={handleSearchResults} />;
    case 'episode':
      ...
      />;
    default:
      return <GeniusHomePage handleSearchResults={handleSearchResults} />;
  }
}

// Theme Overview Page
function ThemePage({ data, handleSearchResults }) {
  const router = useRouter();
...
function SeriesPage({ data, themeId, handleSearchResults }) {
  const router = useRouter();
...
function EpisodePage({ data, themeId, seriesId, episodeId, handleSearchResults }) {
  const router = useRouter();
...
function GeniusHomePage({ handleSearchResults }) {
  const router = useRouter();
