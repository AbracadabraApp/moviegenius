        ...
        {currentStep === 'themes' && (
          <div style={styles.section}>
            <div style={styles.heroSection}>
              <p style={styles.goldSubtitle}><span style={{fontSize: '30px', color: '#ffffff', letterSpacing: '1px'}}>DON'T BINGE WAATCH TV</span><br /><span style={{fontSize: '20px'}}>FEAST ON GREAT FILMS INSTEAD</span></p>
