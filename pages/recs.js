...
export default function Landing() {
  ...
  const movieRotations = [
    ['/images/posters/raiders-of-the-lost-ark.jpg', '/images/posters/jaws.jpg', '/images/posters/star-wars.jpg'],
    ['/images/posters/citizen-kane.jpg', '/images/posters/casablanca.jpg', '/images/posters/the-godfather.jpg'], 
  ...
  const popularTags = [
    'Character Development', 'Cinematography', 'Plot Twists', 'Director Study',
    'Genre Analysis', 'Visual Effects', 'Sound Design', 'Editing', 'Themes',
    'Cultural Impact', 'Historical Context', 'Acting Techniques', 'Symbolism'
  ];
        ...
        {currentStep === 'streaming' && (
          <div style={styles.section}>
            <div style={styles.heroSection}>
              <p style={styles.goldSubtitle}><span style={{fontSize: '30px', color: '#ffffff', letterSpacing: '1px'}}>DON'T BINGE TV</span><br />STREAM FILM SCHOOL INSTEAD</p>
              <img src="/images/hero-rotation/hero-1.jpg" alt="MovieGenius Hero" style={styles.heroImage} />
            </div>
              ...
              {displayedServices.map(service => (
                <button
                  ...
                  style={{
                    ...
                    borderColor: formData.streamingServices.includes(service) ? '#374151' : '#d1d5db'
                  }}
                >
                  {service}
                </button>
            ...
            <div style={styles.tutorialCard}>
              ...
              <div style={styles.tutorialSteps}>
                <div style={styles.step}>
                  ...
                  <p style={styles.stepText}>Tap the <Plus size={16} style={{display: 'inline'}} /> icon on any movie poster</p>
                </div>
                ...
                {movieRecommendations.map((movie, index) => (
                  <div key={index} style={styles.movieItem}>
                    <div style={styles.movieInfo}>
                      ...
                      <span style={styles.movieMeta}>{movie.year} • {movie.genre}</span>
                    </div>
                ...
                {episodeRecommendations.map((episode, index) => (
                  <div key={index} style={styles.episodeItem}>
                    ...
                    <div style={styles.episodeInfo}>
                      ...
                      <span style={styles.episodeItemMeta}>{episode.type} • {episode.duration}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={styles.footer}>
            ...
            <div style={styles.footerSection}>
              ...
              <div style={styles.platformPicker}>
                ...
                <button style={{...styles.platformButton, backgroundColor: '#3b82f6', color: '#ffffff'}}>Mobile</button>
              </div>
            </div>
          </div>
        )}
...
const styles = {
  ...
  heroOverlay: {
    ...
    right: 0,
    bottom: 0,
    background: 'linear-gradient(to bottom, rgba(52, 58, 64, 0.5) 0%, rgba(52, 58, 64, 0.6) 50%, rgba(52, 58, 64, 0.4) 100%)',
    display: 'flex',
    flexDirection: 'column',
    justifyContent: 'flex-start',
    alignItems: 'center',
