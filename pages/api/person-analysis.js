...
export default async function handler(req, res) {
  ...
  try {
    ...
    const promptConfig = buildPrompt('PERSON', 'Include 4-5 Explore Further topics for deeper career analysis');
    ...
    if (saveError) {
      ...
      console.log(`Saved analysis for ${name} (${birthYear || 'unknown'}) - Cost: $${costEstimate.toFixed(4)}`);
    }
