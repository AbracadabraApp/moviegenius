...
export default function EntityLinkingTest() {
  const [testText, setTestText] = useState(
    `Otto Preminger's "Laura" exemplifies how Expressionist techniques could create an atmosphere of obsession and uncertainty. Similarly, Robert Siodmak's "The Spiral Staircase" (1946) employs expressionistic techniques to build psychological tension. Carol Reed's "The Third Man" (1949), though British, represents perhaps the fullest realization of these principles.`
  );
  ...
  const sampleMovies = [
    { title: 'Laura', year: 1944, slug: 'laura-1944', tmdb_id: 396 },
    {
      ...
      year: 1946,
      slug: 'the-spiral-staircase-1946',
      tmdb_id: 25843,
    },
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Test conservative movie title linking with "Title" (Year) pattern
        </p>
      </div>
