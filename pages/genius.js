/**
 * Genius Page - Same as Homepage
 * 
 * Genius page focused on film education themes.
...
export default function GeniusPage() {
  ...
  const handleThemeClick = (theme) => {
    ...
    // Add/remove theme from selected themes
    ...
    setFormData({ ...formData, selectedThemes: newThemes });
  };
  ...
  const startLearning = () => {
    ...
    // Navigate to the user's first selected theme or default to film-noir
    const firstTheme = formData.selectedThemes[0] || 'Film Noir';
    const themeRoutes = {
      'Film Noir': '/film-noir',
      'Horror & Suspense': '/horror-suspense',
      'Comedy': '/comedy-through-time',
      ...
      <div style={styles.container}>
        ...
        {currentStep === 'themes' && (
          <div style={styles.section}>
            ...
            <div style={styles.contentSection}>
              ...
              {allEducationThemes.map(theme => (
                <button
                  ...
                  style={{
                    ...styles.themeButton,
                    backgroundColor: formData.selectedThemes.includes(theme) ? '#d4af37' : '#ffffff',
                    color: formData.selectedThemes.includes(theme) ? '#000000' : '#2c3e50',
                  }}
                >
                  {theme}
                </button>
            ...
            {/* Continue button - only show if themes selected */}
            {formData.selectedThemes.length > 0 && (
              <button
                onClick={nextStep}
                style={{...styles.saveButton, marginTop: '20px'}}
              >
