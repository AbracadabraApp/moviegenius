          ...
          {showSearchResults ? (
            ...
            <>
              <div style={styles.header}>
                ...
                <h1 style={styles.title}>Comedy Through Time</h1>
                <p style={styles.description}>
                  From silent slapstick to modern satire, laughter has evolved with cinema itself
                </p>
              </div>
              
              <div style={styles.content}>
                <p>Comedy through time content will be displayed here.</p>
              </div>
            </>
          )}
        </div>
