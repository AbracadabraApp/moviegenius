...
**CRITICAL**: These components are LOCKED against modification to prevent architectural reversions.
...
**Remember**: These locks exist because of "runaway evolutionary architecture" that caused months of reversions.