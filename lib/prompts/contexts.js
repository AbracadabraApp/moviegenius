...
- FIRST section: Jump right into the plot, main characters, and what makes this story compelling. No movie references required - focus on the story itself. CREATE A COMPELLING SUBHEAD that captures the story's essence (2-4 words, not generic).
- SECOND section: Focus on key performances and acting. Include 1-2 movie references when natural for comparison. Add 1 sentence of honest critique about performance weaknesses. CREATE A SPECIFIC SUBHEAD about the acting/performances (2-4 words).
- THIRD section: Director's vision, cinematography, and technical elements. Include 1-2 movie references for stylistic context. Add 1 sentence of honest critique about technical execution. CREATE A DISTINCTIVE SUBHEAD about the filmmaking craft (2-4 words).
- FOURTH section: Social importance, entertainment value, cultural impact, and contemporary relevance. Include 2-3 movie references for cultural/genre context. Add 1 sentence of honest critique about genre execution or relevance limitations. CREATE AN ENGAGING SUBHEAD about cultural significance (2-4 words).
...
3. Dynamic Subhead Requirements:
- Subheads should be SPECIFIC to this film, not generic (avoid "Plot Summary", "Acting", "Direction", "Cultural Impact")
- Use 2-4 words that capture the essence of what makes THIS film unique
- Examples of GOOD subheads: "Gotham's Dark Knight", "Pacino's Explosive Energy", "Scorsese's Kinetic Violence", "Wall Street Excess"  
- Examples of BAD subheads: "Plot and Characters", "Acting Performances", "Technical Elements", "Social Themes"
- Make subheads compelling and specific to the movie's distinctive elements

4. Comprehensive Analysis Focus:
...

{
  ...
  "content": [
    {
      "subhead": "Story Subhead Here",
      "text": ""
    },
    {
      "subhead": "Performance Subhead Here",
      "text": ""
    },
    {
      "subhead": "Technical Subhead Here", 
      "text": ""
    },
    {
      "subhead": "Cultural Subhead Here",
      "text": ""
    }
  ],
  "featuredMovies": [
