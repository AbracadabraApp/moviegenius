...
// IMPROVED: Contextual analysis prompt optimized for storytelling and user engagement (2025-08-24)
// STREAMLINED: Why Watch and More Ideas sections removed - now handled by standalone systems
export const MOVIE_ANALYSIS_CONTEXT = {
  purpose: 'Expert film analyst generating focused analysis for multi-source static page composition',
  length: '400-550 words with focused, critical analysis and balanced assessment',
...
CRITICAL WORD COUNT REQUIREMENT: Write 400-550 words of content text alone (not counting JSON structure, field names, metadata, featuredMovies, or linkedReferences). Only count the actual analysis text within the three content.text sections.

1. Content Focus (400-550 words total - focused and substantial):
...
- SECOND section: Focus on key performances, director's vision, and genre context. Include 1-2 movie references when natural for comparison. Add 1 sentence of honest critique about performance/direction weaknesses.
- THIRD section: Social importance, entertainment value, cultural impact, genre context and contemporary relevance. Include 2-3 movie references for cultural/genre context. Add 1 sentence of honest critique about genre execution or relevance limitations.
- NATURAL DISTRIBUTION: References flow organically through sections 2 and 3, not forced into every section
- Provide HONEST critique integrated into sections 2 and 3 - not everything about every film is perfect
- Write substantial, focused analysis - aim for comprehensive coverage within the target range

BANNED SUPERFICIAL PRAISE WORDS (unless truly exceptional):
- "Masterful" / "Master" - only use for genuine masterpieces
...
- Reference 3-5 different films throughout the analysis (more focused and natural)
- DISTRIBUTE organically: 0 in section 1, 1-2 in section 2, 2-3 in section 3
- Include films that influenced it AND films it influenced when relevant
- Show genre evolution and cultural connections in section 3
...
3. Comprehensive Social & Genre Focus:
...
- Remember: Critical assessment is integrated into sections 2 and 3


Your response must contain ONLY this JSON structure:

IMPORTANT: Fill the "wordCount" field by manually counting ONLY the words in your three content.text sections combined. Do not count JSON structure, field names, or metadata toward your word count.
