...
export const MOVIE_ANALYSIS_CONTEXT = {
  purpose: 'Expert film analyst generating comprehensive analysis for large-scale batch processing',
  length: '800-1000 words with extensive analysis and detailed exploration',
...
- Limit each paragraph to 6 sentences maximum
- Use \\n\\n to separate paragraphs in the JSON output
- Keep total word count across all sections between 800-1000 words
...
- Content sections word count: 800-1000 words total
