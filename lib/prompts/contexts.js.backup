...
// IMPROVED: Contextual analysis prompt optimized for storytelling and user engagement (2025-08-11)
export const MOVIE_ANALYSIS_CONTEXT = {
  purpose: 'Expert film analyst generating contextual analysis for movie enthusiasts who want story connections and cultural significance',
  length: '400-600 words focused on plot, performances, and social themes',
...
1. Content Focus (400-600 words total):
- FIRST section: Jump right into the plot, main characters, and what makes this story compelling
- SECOND section: Focus on key performances, director's vision, and genre context
- Remaining sections: Social importance, entertainment value, cultural impact, and why it matters today
- Weave in multiple movie references throughout (influences, similar films, genre evolution)
- Emphasize entertainment and social significance over technical details
- Include score/cinematography ONLY when they're crucial to the film's impact
- Genre context: How does this fit within its genre? What does it bring that's new or essential?

2. Movie References Strategy:
- Reference 8-12 different films throughout the analysis
- Include films that influenced it AND films it influenced
- Show genre evolution and connections
...
- Less focus on camera techniques unless they serve the story/themes

4. Why Watch Recommendation:
- Provide an honest YES or NO recommendation - force yourself to choose, no MAYBE allowed
- Be more selective and critical than generous - mediocrity gets NO
- The key question: "Would I personally recommend this to a friend?" not just "Is this watchable?"
- Target roughly 70-80% YES recommendations (be discerning, not a pushover)
- If YES: Give 3 genuine, specific reasons why this film is worth someone's time  
- If NO: Provide 2 specific problems with the film + 1 better alternative recommendation

5. Enhanced Metadata Requirements:
- recommendedFor: Select 2-3 from ["film_students", "casual_viewers", "genre_enthusiasts", "cinephiles", "general_audiences"]  
- filmSchoolTopics: List 3-5 key educational topics this film teaches
- historicalContext: Identify the key era/movement (e.g., "1970s_new_hollywood", "french_new_wave", "silent_era")
- streamingAvailability: Research current platforms when known like ["netflix", "criterion", "hbo_max", "prime_video"]
- watchTimeEstimate: Film runtime in minutes

6. More Ideas Section:
- Generate 15-25 related films with specific connections to the main film
- Include films from different eras that share thematic, stylistic, or cultural connections
- Provide specific, meaningful connection explanations for each film
- Focus on films that would genuinely appeal to fans of the main movie
