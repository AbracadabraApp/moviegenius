...
export const staticRoutes = {
  ...
  movies: '/movies',
  genius: '/genius',
  you: '/you', // Legacy - redirect to what-to-watch
  whatToWatch: '/what-to-watch',
};

// Navigation items for NavBar
// Genius is hidden by default (easter egg: ?genius=true in URL)
export const navItems = [
  { label: 'Movies', icon: 'Clapperboard', route: staticRoutes.movies },
  { label: 'Genius', icon: 'Sparkles', route: staticRoutes.genius },
  { label: 'You', icon: 'User', route: staticRoutes.whatToWatch },
];

// Full nav items including hidden Genius (for easter egg mode)
export const navItemsWithGenius = [
  { label: 'Movies', icon: 'Clapperboard', route: staticRoutes.movies },
  { label: 'Genius', icon: 'Sparkles', route: staticRoutes.genius },
  { label: 'You', icon: 'User', route: staticRoutes.whatToWatch },
];
