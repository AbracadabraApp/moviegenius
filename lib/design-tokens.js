...
export const components = {
  ...
  // You page specific values
  youPage: {
    headerSpacing: spacing[8],
    sectionSpacing: spacing[6],
    cardSpacing: spacing[4],
    profileImageSize: '80px',
    statItemMinHeight: '64px',
    collectionGridGap: spacing[3],
    learningProgressHeight: '6px',
    goldAccent: '#d4af37',
    goldAccentHover: '#b8941f',
    emptyStateIconSize: '48px',
    // Disabled states for progressive enhancement
    disabledState: {
      opacity: '0.6',
      cursor: 'not-allowed',
