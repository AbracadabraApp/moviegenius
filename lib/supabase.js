...
// Client for browser/frontend use - NO placeholder fallbacks (mirrors search fix pattern)
if (!supabaseUrl || !supabaseAnonKey) {
  console.error('❌ Supabase client authentication failed: credentials not configured');
}
