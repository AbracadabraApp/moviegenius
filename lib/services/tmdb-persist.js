...
export async function ensureMovieInDb(tmdbMovie) {
  ...
  const result = await pool.query(
    `INSERT INTO movies (tmdb_id, title, official_title, year, release_date, poster_url, title_normalized, updated_at)
    ...
    [tmdbId, title, year, releaseDate, posterUrl, titleNormalized]
  );
